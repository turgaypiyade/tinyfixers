# LineHSpecial hit-based chain patch

Path: `Assets/_Project/Scripts/Grid/Board/Specials/LineHSpecial.cs`

## 1) Runtime alanları

`LineHExecutionRuntime` sonuna ekle:
...
```csharp
private List<BoardAction> ExecuteSpecialAtLineHit(LineHExecutionRuntime rt, Vector2Int cell)
{
