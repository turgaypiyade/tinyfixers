...
The first boss remains a very easy introduction. Later bosses use one power per cleared
tile, making two-point shield pickups meaningful against the new damage scale. HP still
...
At a constant 30 clears/move, the simplified damage budgets require 2/8/9/11/11/13/13/14/16
moves respectively, leaving 95/85/70/61/52/57/52/58/43 player HP before shield benefits.
